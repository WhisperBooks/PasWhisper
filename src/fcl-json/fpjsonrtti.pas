...
Type
  ...
  protected
    ...
    Function StreamProperty(Const AObject : TObject; Const PropertyName : String) : TJSONData; overload;
    Function StreamProperty(Const AObject : TObject; PropertyInfo : PPropInfo) : TJSONData; overload;
  ...
  Public
    ...
    Procedure JSONToObject(Const JSON : TJSONStringType; AObject : TObject); overload;
    Procedure JSONToObject(Const JSON : TJSONObject; AObject : TObject); overload;
    // Convert JSON object/array to collection.
    Procedure JSONToCollection(Const JSON : TJSONStringType; ACollection : TCollection); overload;
    Procedure JSONToCollection(Const JSON : TJSONData; ACollection : TCollection); overload;
    // Convert JSON array/object/string to TStrings
    Procedure JSONToStrings(Const JSON : TJSONStringType; AStrings : TSTrings); overload;
    Procedure JSONToStrings(Const JSON : TJSONData; AStrings : TSTrings); overload;
    // Convert JSON data to a variant. Supports simple data types and arrays.
    Function JSONToVariant(Data: TJSONData): Variant; overload;
    Function JSONToVariant(Data: TJSONStringType): Variant; overload;
